...
//            _goodPageResult = pageRequster.MakeRequestAsync(new Uri("http://localhost.fiddler:1111/"));
//            _badPageResult = pageRequster.MakeRequestAsync(new Uri("http://localhost.fiddler:1111/HttpResponse/Status404"));
//        }
