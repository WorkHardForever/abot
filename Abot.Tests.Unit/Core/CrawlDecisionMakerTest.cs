...
//            CrawlDecision result = _unitUnderTest.ShouldDownloadPageContent(new PageRequester(new CrawlConfiguration { UserAgentString = "aaa" }).MakeRequestAsync(valid200StatusUri), _crawlContext);
...
//            CrawlDecision result = _unitUnderTest.ShouldDownloadPageContent(new PageRequester(_crawlContext.CrawlConfiguration).MakeRequestAsync(non200Uri), new CrawlContext());
...
//            CrawlDecision result = _unitUnderTest.ShouldDownloadPageContent(new PageRequester(_crawlContext.CrawlConfiguration).MakeRequestAsync(imageUrl), _crawlContext);
...
//            CrawlDecision result = _unitUnderTest.ShouldDownloadPageContent(new PageRequester(crawlConfiguration).MakeRequestAsync(valid200StatusUri), _crawlContext);
...
//            CrawlDecision result = _unitUnderTest.ShouldDownloadPageContent(new PageRequester(_crawlContext.CrawlConfiguration).MakeRequestAsync(valid200StatusUri), 
//                new CrawlContext
//                {
//                    CrawlConfiguration = new CrawlConfiguration
//                    {
