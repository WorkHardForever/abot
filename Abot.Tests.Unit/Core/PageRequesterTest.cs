...
//        {
//            CrawledPage result = _unitUnderTest.MakeRequestAsync(_validUri);
...
//        {
//            CrawledPage result = _unitUnderTest.MakeRequestAsync(_403ErrorUri);
...
//        {
//            CrawledPage result = _unitUnderTest.MakeRequestAsync(_404ErrorUri);
...
//        {
//            CrawledPage result = _unitUnderTest.MakeRequestAsync(_500ErrorUri);
...
//        {
//            CrawledPage result = _unitUnderTest.MakeRequestAsync(_503ErrorUri);
...
//        {
//            CrawledPage result = _unitUnderTest.MakeRequestAsync(_502ErrorUri);
...
//        {
//            CrawledPage result = _unitUnderTest.MakeRequestAsync(_301To200Uri);
...
//        {
//            CrawledPage result = _unitUnderTest.MakeRequestAsync(_301To404Uri);
...
//        {
//            Assert.Throws<ArgumentNullException>(() => _unitUnderTest.MakeRequestAsync(null));
//        }

//        [Test]
//        public void MakeRequest_CrawlDecisionReturnsFalse_CrawlsPageButDoesNotDowloadContent()
//        {
//            CrawledPage result = _unitUnderTest.MakeRequestAsync(_validUri, (x) => new CrawlDecision { Allow = false });
