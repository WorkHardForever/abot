...
namespace Abot.Poco
{
	...
	/// <remarks>
	/// We use this wrapper class to enable using responses obtained by methods
	/// different than executing an HttpWebRequest.
	/// E.g. one may use a browser control embedded in the application to get
	/// a page content and construct an instance of this class to pass it to Abot.
	/// </remarks>
	public class HttpWebResponseWrapper
	{
		...
		/// <summary>
		/// TODO: Requared for authentication. Maybe in future someone can solve this.
		...
		/// <summary>
		/// Constructs a response based on the received system http response
		/// </summary>
		...
		/// <summary>
		/// Server designated type of content
		/// </summary>
		public string ContentType { get; set; }

		/// <summary>
		/// Server designated length of content in bytes
		/// </summary>
		public long ContentLength { get; set; }

		/// <summary>
		/// Collection of headers in the response
		/// </summary>
		...
		/// <summary>
		/// Was the response generated from the local cache?
		/// </summary>
